...
Mark static arguments - Use static_argnums for non-array parameters in JIT
Use functional updates - Always use .at methods for array modifications
Profile before optimizing - Use jax.profiler to find bottlenecks
Handle device placement - Use jax.device_put() to control where arrays live
Test on CPU first - Debug on CPU, then scale to GPU/TPU
