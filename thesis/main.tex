...
The standard benchmark suite \cite{brockman_openai_2016, duan_efficient_2016} is built on the MuJoCo physics engine (Todorov et al., 2012), whose fast and accurate contact dynamics made physically grounded locomotion tasks tractable for reinforcement-learning research.
...
\label{subsubsec:genome-representation-and-the-padding-scheme}
